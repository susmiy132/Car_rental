...
lb1=Label(fr,text="Honda Civic",font=('Roboto','15','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=200)
lb2=Label(fr,text="No Plate :    ba 1 cha 1516",font=('Robotobg','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=230)
lb3=Label(fr,text="Model No :    AGF No.103",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=260)
lb4=Label(fr,text="Car Availibility :     yes",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=290)
lb5=Label(fr,text="Model year :     2008",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=320)
lb5=Label(fr,text="Model year :     2008",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=320)
lb6=Label(fr,text="Last Serviced Date:  2022",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=350)
lb7=Label(fr,text="Cost:  5000/d",font=('Roboto','9','bold'),bg="#FEFBF3",fg="#EB6383").place(x=115,y=380)
